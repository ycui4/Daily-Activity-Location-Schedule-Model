...
library(dplyr)
DataV0<-read.csv('/Users/yu/Documents/Study/Project/Simulation/Work/20190124 Survival Model/Level 3/2.Validation.csv', header=T, stringsAsFactors = FALSE)
...
GVS<-read.csv('/Users/yu/Documents/Study/Project/Simulation/Work/20181201/Unknow DBSCAN/7.GVS.csv', stringsAsFactors = FALSE, header=T)
TVS<-read.csv('/Users/yu/Documents/Study/Project/Simulation/Work/20181201/Unknow DBSCAN/7.TVS.csv', stringsAsFactors = FALSE, header=T)
...
PVS<-read.csv('/Users/yu/Documents/Study/Project/Simulation/Work/20181201/Unknow DBSCAN/7.PVS.csv', stringsAsFactors = FALSE, header=T)
    ...
    if(length(b1)>0){
      ...
      if(nrow(Score)>0){
        ...
        if(d3=='Home'){
          ...
          d4<-'Work'
        }else if(length(grep('Unknow', d3))==1){
          d4<-'Unknow'
        }else{
...
table(a$UsedScore)       #1-73458, 2-64572, 3-6711 
