...
Data0<-read.csv('/Users/yu/Documents/Study/Project/Simulation/Work/20190124 Survival Model/Level 3/1.Training.csv', header=T, stringsAsFactors = FALSE)
...
Data$ActivityType[grep('Unknow', Data$Data0.CurPlace)]<-'Unknow'
...
write.csv(x, '/Users/yu/Desktop/Trip1/b3.csv', row.names = FALSE)

b1<-read.csv('/Users/yu/Desktop/Trip1/b1.csv', header=T, stringsAsFactors = FALSE)
b2<-read.csv('/Users/yu/Desktop/Trip1/b2.csv', header=T, stringsAsFactors = FALSE)
b3<-read.csv('/Users/yu/Desktop/Trip1/b3.csv', header=T, stringsAsFactors = FALSE)
b<-rbind(b1, b2, b3)
