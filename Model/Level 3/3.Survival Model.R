...
### Train ###
DataT<-read.csv('/Users/yu/Documents/Study/Project/Simulation/Work/20190124 Survival Model/Level 3/2.Training.csv', header=T, stringsAsFactors = FALSE)
...
mean(abs(aWeekday$SDDiff)/aWeekday$StayDuration)  ### 1.17753
...
mean(abs(aWeekday1$SDDiff)/aWeekday1$StayDuration)  ### 1.289823
