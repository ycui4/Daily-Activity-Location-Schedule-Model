...
Data0<-read.csv('/Users/yu/Documents/Study/Project/Simulation/Work/20190124 Survival Model/Level 1/1.Validation.csv', header=T, stringsAsFactors = FALSE)
...
write.csv(x, '/Users/yu/Desktop/Trip1/b2.csv', row.names = FALSE)
